...
// using namespace furi::code_point;
//
// and have `swap` be found via ADL without implicitly pulling in all of furi into the scope
//
...
#endif // FURI_CODE_POINT_ITERATOR_HPP_
