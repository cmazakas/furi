...
TEST_CASE("pct_encode_test")
{
    ...
    "representation")
  {
    ...
    //
    {
      ...
      furi::utf8_encode(code_points.begin(), code_points.end(), utf8_bytes.begin());
  ...
  {
    auto const host = std::u32string_view(U"%20%13%24!$'()*+,;=");

    auto out = std::string(256, '\0');

    auto const end          = furi::uri::encode_host(host, out.begin());
    auto const encoded_host = std::string_view(out.data(), end - out.begin());
  ...
  {
    auto const host = std::u32string_view(U"hello world!\n");
    auto       out  = std::string(256, '\0');

    auto const encoded_host =
      std::string_view(out.data(), furi::uri::encode_host(host, out.begin()) - out.begin());
  ...
  {
    auto const host = std::u32string_view(U"www.\u017C\u00F3\u0142\u0107.pl");
    auto       out  = std::string(256, '\0');
  ...
  {
    auto const host = std::u32string_view(U"127.0.0.1");
    auto       out  = std::string(256, '\0');
  ...
  {
    auto const host = std::u32string_view(U"[::]");
    auto       out  = std::string(256, '\0');
  ...
  {
    auto const host = std::u32string_view(
  ...
  {
    auto const path = std::u32string_view(
      U"/ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-._~!$&'()*+,;=");

    auto out = std::string(256, '\0');

    auto const encoded_path =
      std::string_view(out.data(), furi::uri::encode_path(path, out.begin()) - out.begin());
  ...
  {
    auto const path = std::u32string_view(U"////1.234/432/@@");
  ...
  {
    auto const path = std::u32string_view(U"/\"#<>?@[\\]^`{|}:::");
    auto       out  = std::string(256, '\0');
  ...
  {
    auto const path = std::u32string_view(U"/%20%21%22%23");
    auto       out  = std::string(256, '\0');
  ...
  {
    auto const query = std::u32string_view(U"?%20%21%22%23");
    auto       out   = std::string(256, '\0');

    auto const encoded_query =
      std::string_view(out.data(), furi::uri::encode_query(query, out.begin()) - out.begin());
  ...
  {
    auto const query = std::u32string_view(
      U"?ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-._~!$&'()*+,;=/?");
    auto out = std::string(256, '\0');
  ...
  {
    auto const query = std::u32string_view(U"?//\":#/<>?@[\\]^`{|}");
    auto       out   = std::string(256, '\0');
  ...
  {
    auto const query =
      std::u32string_view(U"?q=\u0412\u0441\u0435\u043c \u043f\u0440\u0438\u0432\u0435\u0442");
    auto out = std::string(256, '\0');
