...
TEST_CASE("unicode_uri_test")
{
  SECTION("should parse the sub-delims")
  {
    ...
    auto const matched_all_sub_delims =
      std::all_of(delims.begin(), delims.end(), [](auto const delim) -> bool {
        ...
        return x3::parse(begin, end, furi::uri::unicode::sub_delims);
      });
    ...
    auto const non_match = !x3::parse(begin, end, furi::uri::unicode::sub_delims);
  ...
  SECTION("should parse the gen-delims")
  {
    ...
    auto const matched_all_gen_delims =
      std::all_of(delims.begin(), delims.end(), [](auto const delim) -> bool {
        ...
        return x3::parse(begin, end, furi::uri::unicode::gen_delims);
      });
    ...
    auto const non_match = !x3::parse(begin, end, furi::uri::unicode::gen_delims);
  ...
  SECTION("should parse the reserved")
  {
    ...
    auto const matched_all_reserved =
      std::all_of(delims.begin(), delims.end(), [](auto const delim) -> bool {
        ...
        return x3::parse(begin, end, furi::uri::unicode::reserved);
      });
...

    {
      ...
      auto const non_match = !x3::parse(begin, end, furi::uri::unicode::reserved);
...

    {
      ...
      auto const match = x3::parse(begin, end, +furi::uri::unicode::unreserved);
  ...
  SECTION("should support percent encoded parsing")
  {
    ...
    auto const match = x3::parse(begin, end, furi::uri::unicode::pct_encoded);
  ...
  SECTION("should support the pchar")
  {
    ...
    //
    {
      ...
      auto const match = x3::parse(begin, end, +furi::uri::unicode::pchar);
    ...
    //
    {
      ...
      auto const matched_all_sub_delims =
        std::all_of(delims.begin(), delims.end(), [](auto const delim) -> bool {
          ...
          return x3::parse(begin, end, furi::uri::unicode::pchar);
        });
  ...
  {
    {
      ...
      auto const match1 = x3::parse(begin, end, furi::uri::unicode::query);

      begin             = view.begin();
      auto const match2 = x3::parse(begin, end, furi::uri::unicode::fragment);
  ...
  SECTION("should support decimal octet parsing")
  {
    ...
    auto const all_match =
      std::all_of(valid_inputs.begin(), valid_inputs.end(), [](auto const view) -> bool {
        ...
        auto const match = x3::parse(begin, end, furi::uri::unicode::dec_octet);
  ...
  SECTION("should support IPv4 address parsing")
  {
    ...
    auto const all_match =
      std::all_of(valid_inputs.begin(), valid_inputs.end(), [](auto const view) -> bool {
        ...
        auto const match = x3::parse(begin, end, furi::uri::unicode::ip_v4_address);
  ...
  SECTION("should support IPv6 address parsing")
  {
    ...
    auto const all_match =
      std::all_of(valid_inputs.begin(), valid_inputs.end(), [](auto const view) -> bool {
        ...
        auto const match      = x3::parse(begin, end, furi::uri::unicode::ip_v6_address);
        auto const full_match = match && (begin == end);
  ...
  SECTION("should support URI parsing")
  {
    ...
    auto const all_match =
      std::all_of(valid_inputs.begin(), valid_inputs.end(), [](auto const view) -> bool {
        ...
        auto const match      = x3::parse(begin, end, furi::uri::unicode::uri);
        auto const full_match = match && (begin == end);
